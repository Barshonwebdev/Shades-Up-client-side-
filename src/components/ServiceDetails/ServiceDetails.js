...
const ServiceDetails = () => {
    ...
    return (
            ...
            <div className="details-div">
                ...
                <h2 > <span className="text-danger"> Product Name: </span> {allData?.Name}</h2>
                <img className="img-fluid" src={allData?.image} 
                alt=""/>
                <div className="description">
                    <h4> <span className="text-danger">  Details: </span> {allData?.Description}</h4>
                    <h4> <span className="text-danger">  Price: </span> {allData?.Price}</h4>
                </div>
                <div className="form">
                    <h1>Wanna purchase this product? Fill the form!</h1>
